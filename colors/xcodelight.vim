...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'xcodelight_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
hi ErrorMsg guifg=#c64343 guibg=NONE gui=NONE cterm=NONE
...
hi DiagnosticVirtualTextError guibg=#FFC3C5 guifg=#960000
...
hi Error guifg=#c64343 guibg=NONE gui=NONE cterm=NONE
